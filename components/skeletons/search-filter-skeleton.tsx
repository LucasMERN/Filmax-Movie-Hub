    ...
    <div className="relative z-50 w-full rounded-3xl bg-foreground p-6">
      <div className="flex flex-col gap-4 lg:flex-row lg:justify-between lg:gap-8">
        ...
        <div className="flex w-full flex-col gap-4 lg:flex-row lg:gap-6">
          <Skeleton className="h-17 w-full rounded-2xl px-6 text-white ring-offset-background transition-colors focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 lg:h-auto" />
